...
I want you to implement @prd.md 

use /hackathon-app-dev 

download, install and set font-coolvetica for the font-coolvetica class. and use that font in the landing as hero and some other places relevant. 

for the base font use Inter from Google fonts. 

For the brand and theming use the colors from  @brand-moodboard/brand.png 

Use /hackathon-landing-pwa for the landing page. 

Build everything under the worldtars directory - ive already initialized the mini app in it - we dont have to set up supabase or privy for this project.

do everything and recheck if you've completed everything, and complete everything ive asked you to complete.

I want you to use the logo and brand image from the public folder and set faviocon, logos, icons and stuff